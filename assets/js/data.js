...
newCv.innerHTML = `<div class="cv shadow-lg mt-6 bg-white relative grid grid-cols-3 gap-8 w-full mx-auto max-w-screen-lg p-8 rounded-lg">
            ...
            <ul class="cv__event">
              <li>
                <div class="gap-3 flex justify-between">
                  <h5 class="cv__section-title cv__section-title--sm">Environmental and Public Affairs</h5>
            ...
            <ul class="cv__event">
              <li>
                <div class="flex justify-between">
                  <h5 class="cv__section-title cv__section-title--sm flex gap-2 w-full justify-between gap-0">
                    <span>Lot 48</span>
                  </h5>
                </div>
