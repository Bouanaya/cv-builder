...
//hobbies
  ...
  educationData = {
      institution:educate[i],
      degree:degreEduacation[i],
      field :stady[i],
      years:educationYears[i],
    };
...
const newCv = document.querySelector(".CV1")
// newCv.innerHTML = `<div class="cv hidden shadow-lg mt-6 bg-white relative grid grid-cols-3 gap-8 w-full mx-auto max-w-screen-lg p-8 rounded-lg">
...
<div class="bg-gray-100 font-sans">
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <h1 class="text-3xl font-semibold">John Doe</h1>
            ...
            <ul class="list-disc list-inside text-gray-700">
                ...
                <li>LinkedIn: <a href="https://www.linkedin.com/in/johndoe"
                        class="text-blue-500 hover:underline">linkedin.com/in/johndoe</a></li>
                <li>Website: <a href="https://www.johndoe.com" class="text-blue-500 hover:underline">johndoe.com</a>
                </li>
            </ul>
        </div>
    </div>
